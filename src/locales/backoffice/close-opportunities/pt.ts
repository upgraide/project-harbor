export default {
  ...
  updateDialog: {
    ...
    description:
      "Alterar o estado e atualizar valores finais desta oportunidade",
    labels: {
      status: "Novo Estado",
    ...
    placeholders: {
      ...
      followupPerson:
        "Selecione o responsável pelo acompanhamento do investidor",
    ...
    helper: {
      ...
      clientOriginator:
        "Função de comissão: pessoa responsável por trazer o investidor",
      // NOT a commission role - clarify this
      investedPerson:
        "Apenas registo: o cliente/investidor que investiu (sem comissão)",
      // Commission role explanation
      followupPerson:
        "Função de comissão: pessoa responsável pelo acompanhamento do investidor",
    },
