  ...
  dashboardRealEstateOpportunityPage: {
    ...
    financialInformationCard: {
      ...
      table: {
        ...
        metrics: {
          asset: "Asset",
          nRoomsLastYear: "Number of Rooms Last Year",
          noi: "NOI",
          occupancyLastYear: "Occupancy Last Year",
          walt: "WALT",
          ...
          subYield: "Sub Yield",
          capex: "Capex",
          capexPerSqm: "Capex Per Sqm",
          sale: "Sale",
          salePerSqm: "Sale Per Sqm",
          location: "Location",
          area: "Area",
          value: "Value",
          yield: "Yield",
          rent: "Rent",
          gcaAboveGround: "GCA Above Ground",
          gcaBelowGround: "GCA Below Ground",
          // Additional metrics from image
          numberOfBedrooms: "Number of Bedrooms",
          ocupationExpected: "Occupation (expected)",
          licensingStage: "Licensing Stage",
          ...
          promoteStructure: "Promote Structure",
          projectIRR: "Project IRR",
          investorIRR: "Investor IRR",
          coInvestmentHoldPeriod: "Hold Period (Years)",
          coInvestmentBreakEvenOccupancy: "Break-even Occupancy",
          years: "years",
        },
        values: {
          agnostic: "Agnostic",
          hospitality: "Hospitality",
          logisticsIndustrial: "Logistics & Industrial",
          office: "Office",
          ...
          // Development values
          vendaPerSqmOrExitYield: "Sale/m2 or Exit Yield",
          venda: "Sale",
        },
      },
    },
