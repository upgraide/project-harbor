  ...
  backofficeMergersAndAcquisitionsOpportunityPage: {
    ...
    editOpportunityIndustryDialog: {
      ...
      content: {
        industry: {
          services: "Serviços",
          transformationindustry: "Indústria de Transformação",
          trading: "Comércio",
          energyandinfrastructure: "Energia & Infraestrutura",
          fitness: "Fitness",
          healthcareandpharmaceuticals: "Saúde & Farmacêutica",
          it: "IT",
          tmt: "TMT (Tecnologia, Mídia & Telecomunicações)",
          transports: "Transportes",
        },
        industrySubsector: {
          businessservices: "Serviços de Negócios",
          financialservices: "Serviços Financeiros",
          constructionandmaterials: "Construção & Materiais",
          foodandbeverages: "Alimentos & Bebidas",
          others: "Outros",
        },
      },
    },
