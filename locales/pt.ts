export default {
  ...
  backofficeMergersAndAcquisitionsOpportunityPage: {
    ...
    editOpportunityIndustryDialog: {
      title: "Editar Indústria da Oportunidade",
      description: "Editar a indústria da oportunidade",
      toastSuccess: "Indústria da oportunidade atualizada com sucesso",
      toastError: "Falha ao atualizar indústria da oportunidade",
      toastLoading: "A atualizar indústria da oportunidade",
      label: "Indústria",
      selectPlaceholder: "Selecione uma opção",
      industrySubsectorLabel: "Subsetor da Indústria",
      updateButton: "Atualizar Indústria",
      content: {
        industry: {
          services: "Serviços",
          transformationindustry: "Indústria Transformadora",
          trading: "Comércio",
          energyandinfrastructure: "Energia e Infraestruturas",
          fitness: "Fitness",
          healthcareandpharmaceuticals: "Saúde e Farmacêutica",
        ...
        industrySubsector: {
          ...
          constructionandmaterials: "Construção e Materiais",
          foodandbeverages: "Alimentação e Bebidas",
          others: "Outros",
        },
      },
    },
  ...
  dashboardMergersAndAcquisitionsOpportunityPage: {
    ...
    financialInformationCard: {
      ...
      table: {
        ...
        metrics: {
          ...
          sales: "Vendas",
          ebitda: "EBITDA",
          ebitdaNormalized: "EBITDA (Ajustado)",
          netDebt: "Net Debt",
          cagr: "CAGR",
          salesCAGR: "CAGR de Vendas",
          ebitdaCAGR: "EBITDA CAGR",
          asset: "Ativo",
          assetIncluded: "Ativo Incluído",
          estimatedAssetValue: "Valor Estimado do Ativo",
        ...
        values: {
          buyIn: "Capital para Expansão",
          buyOut: "Venda de Participação",
          buyInBuyOut: "Capital para Expansão/Venda de Participação",
          majority: "Maioritário",
          minority: "Minoritário",
          hundredPercent: "100%",
          services: "Serviços",
          transformationindustry: "Indústria Transformadora",
    ...
    furtherInformationCard: {
      ...
      table: {
        ...
        metrics: {
          im: "IM",
          entrepriseValue: "Valor da Empresa",
          equityValue: "Valor do Capital Próprio",
          evDashEbitdaEntry: "Múltiplo EBITDA Entrada",
          evDashEbitdaExit: "Múltiplo EBITDA Comparáveis",
          ebitdaNormalized: "EBITDA Ajustado",
          ebitdaMargin: "EBITDA Margin (%)",
          freeCashFlow: "Cash Flows Descontados",
          netDebtDashEbitda: "EBITDA por Dívida Financeira Líquida (x)",
  ...
  dashboardRealEstateOpportunityPage: {
    description: "Descrição",
    financialInformationCard: {
      title: "Informação Financeira",
      table: {
        ...
        metrics: {
          asset: "Ativo",
          nRoomsLastYear: "Número de Quartos no Ano Passado",
          noi: "NOI (Net Operating Income)",
          occupancyLastYear: "Ocupação no Ano Passado",
          walt: "WALT (Weighted Average Unexpired Lease Term)",
          nBeds: "Número de Camas",
          investment: "Investimento",
          subRent: "Sub Aluguer",
          rentPerSqm: "Renda m² / Renda Estimado por m2",
          subYield: "Sub Rendimento",
          capex: "Capex",
          capexPerSqm: "Capex/m²",
          sale: "Venda",
          salePerSqm: "Venda/m² ou Exit Yield",
          location: "Localização",
          area: "Área",
          value: "Valor",
          yield: "Rendimento",
          rent: "Renda",
          gcaAboveGround: "GCA Acima do Solo",
          gcaBelowGround: "GCA Abaixo do Solo",
          // Additional metrics from image
          numberOfBedrooms: "Número quartos",
          ocupationExpected: "Ocupação (expected)",
          licensingStage: "Fase de licenciamento",
          holdPeriodYears: "Duração investimento",
          breakEvenOccupancy: "Ocupação Break-even",
          occupancyRate: "Taxa de ocupação",
          // Co-Investment metrics
          gpEquity: "Capital Próprio GP",
          totalEquityRequired: "Capitais Próprios necessários",
          sponsorPresentation: "Apresentação Sponsor",
          promoteStructure: "Estrutura Promote",
          projectIRR: "IRR Projeto",
          investorIRR: "IRR Investidor",
          coInvestmentHoldPeriod: "Duração investimento (anos)",
          coInvestmentBreakEvenOccupancy: "Ocupação Break-even",
          years: "anos",
        },
        values: {
          ...
          logisticsIndustrial: "Logística e Industrial",
          office: "Escritórios",
          residential: "Residencial",
          seniorLiving: "Residências Sénior",
          shoppingCenters: "Retalho",
          streetRetail: "Street Retail",
          studentHousing: "Residências de Estudantes",
          // Investment values
          leaseAndOperation: "Lease and Operate",
          sAndL: "S&L",
          core: "Core",
          fixAndFlip: "Fix&Flip",
          ...
          // Development values
          vendaPerSqmOrExitYield: "Venda/m² ou Exit Yield",
          venda: "Venda",
        },
      },
    },
