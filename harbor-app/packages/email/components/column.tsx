...
export function Column({ title, description, footer, imgSrc }: Props) {
  ...
  return (
    <Section className="text-left p-0 m-0">
      <Section className="p-0 m-0 w-full inline-block align-top box-border mb-4 md:mb-0 text-left">
        <Section className="text-left p-0 m-0 pb-10">
          <Img alt={title} className="w-[245px]" src={imgSrc} />
        </Section>
      </Section>
      <Section className="inline-block align-top box-border w-full text-left">
        <Section className="text-left p-0 m-0">
