...
function DeleteOpportunityTypeDetailsDialog({
  opportunity,
  setOpportunity,
}: {
  ...
  const t = useScopedI18n(
    "backofficeMergersAndAcquisitionsOpportunityPage.deleteOpportunityTypeDetailsDialog",
  );
...
export { DeleteOpportunityTypeDetailsDialog };
